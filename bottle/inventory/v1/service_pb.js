...
goog.exportSymbol('proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation', null, global);
 ...
 * @constructor
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.displayName = 'proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    requiredQuantityPerKit: jspb.Message.getFieldWithDefault(msg, 2, 0),
    availableLocationsList: jspb.Message.toObjectList(msg.getAvailableLocationsList(),
    proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.toObject, includeInstance)
  };
...
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation;
      reader.readMessage(value,proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.deserializeBinaryFromReader);
      msg.addAvailableLocations(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getAvailableLocationsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.prototype.toObject = function(opt_includeInstance) {
  return proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation}
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation;
  return proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation}
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.prototype.getLocation = function() {
 ...
 * @return {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation} returns this
*/
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.prototype.setLocation = function(value) {
 ...
 * @return {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation} returns this
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.prototype.clearLocation = function() {
 ...
 * @return {boolean}
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.prototype.hasLocation = function() {
 ...
 * @return {number}
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.prototype.getAvailableQuantity = function() {
 ...
 * @return {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation} returns this
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation.prototype.setAvailableQuantity = function(value) {
...
/**
 * optional int32 required_quantity_per_kit = 2;
 * @return {number}
 */
...
/**
 * repeated AvailableLocation available_locations = 3;
 * @return {!Array<!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation>}
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.prototype.getAvailableLocationsList = function() {
  return /** @type{!Array<!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation, 3));
};


/**
 * @param {!Array<!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation>} value
 * @return {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption} returns this
*/
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.prototype.setAvailableLocationsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};


/**
 * @param {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation=} opt_value
 * @param {number=} opt_index
 * @return {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation}
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.prototype.addAvailableLocations = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.AvailableLocation, opt_index);
};
 ...
 * @return {!proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption} returns this
 */
proto.bottle.inventory.v1.ListComponentAvailabilityResponse.PickingOption.prototype.clearAvailableLocationsList = function() {
  return this.setAvailableLocationsList([]);
};
